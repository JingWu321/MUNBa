...
def celeba_dataloaders(
    batch_size=128,
    data_dir="/home/jing/dataset/CelebAMaskHQ/CelebA_HQ_facial_identity_dataset",
    num_workers=2,
    random_to_replace: int = None,
    class_to_replace: int = None,
    num_indexes_to_replace=None,
    ...
    # unl_identities = np.random.choice(np.unique(train_set.targets), int(0.5 * len(np.unique(train_set.targets))), replace=False)
